...
<body>
    ...
    <section class="wrapper" id="gacha-wrapper">
        ...
        <div id="kakutei-text" class="kakutei-text">
            確定!!
        </div>
                ...
                <svg viewBox="0 0 420 600" width="100%" height="100%">
                    ...
                    <g id="holder">
                        <path
                            ...
                            d="M275.2,564.7c4.7,1.5,9.8,2.3,15,2.3s10.3-0.8,15-2.3v-95.4c-4.7-1.5-9.8-2.3-15-2.3 s-10.3,0.8-15,2.3V564.7z" />
                    </g>
    ...
    <form
        id="gacha-form"
        method="POST"
        action="${pageContext.request.contextPath}/ChooseServlet">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="allergy-list">
                ...
                <label class="allergy-item">
                    ...
                    <c:forEach
                        var="prev"
                        items="${selectedAllergies != null ? selectedAllergies : paramValues.prevAllergies}">
